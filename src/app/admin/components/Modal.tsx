...
export default function Modal({ isOpen, onClose, title, children, maxWidth = "max-w-2xl" }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center sm:p-4">
      ...
      <div className={`relative z-10 ${maxWidth} w-full liquid-glass rounded-t-3xl sm:rounded-3xl shadow-2xl shadow-black/50 max-h-[92vh] sm:max-h-[90vh] flex flex-col`} onClick={(e) => e.stopPropagation()}>
